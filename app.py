...
api = os.getenv("AIzaSyANATt6wGX-lEQM1I1bBdfNIBiWS8owzgo")
os.environ['REPLICATE_API_TOKEN'] = "r8_29f5DJXrA48VHHKF4xK2s4GoejTXuOA3Lo8IM"
palm.configure(api_key="AIzaSyANATt6wGX-lEQM1I1bBdfNIBiWS8owzgo")
model = {
